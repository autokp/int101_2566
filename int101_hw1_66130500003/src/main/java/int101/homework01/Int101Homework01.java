...
public class Int101Homework01 {
   ...
   static void work03UseOfUtilityClass() {
      ...
      */
       System.out.println(calculateBMI(56,181));
       System.out.println(average(5,9,7));
   }
   ...
   static void work04UseOfObjectClass() {
      ...
      */
       ...
       Person owner1 = new Person(001);
       Person owner2 = new Person(002);
       ...
       account1.tranfer(1000 , account2);
